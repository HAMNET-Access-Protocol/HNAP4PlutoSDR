...
void test_packet_inspect_is_tcpip_shortframe(void) {
  uint8_t buf[] = {0x00, 0x00, 0x00, 0xff, 0xff, 0xff,
                   0x00, 0x00, 0x00, 0xee, 0xee, 0xee,
                   0x08, 0x00, 0x45, 0x00, 0x00, 0x34,
                   0xc1, 0x29, 0x40, 0x00, 0x40, 0x06,
                   0x68, 0x2c, 0xc0, 0xa8, 0x01, 0x01,
                   0xc0, 0xa8, 0x01, 0x02};
  uint buflen = 29;
  TEST_ASSERT_EQUAL(-1, packet_inspect_is_tcpip(buf,buflen));
}
